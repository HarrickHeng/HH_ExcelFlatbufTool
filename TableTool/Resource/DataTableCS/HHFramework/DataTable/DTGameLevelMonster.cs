...
public struct DTGameLevelMonster : IFlatbufferObject
{
  ...
  public static Offset<HHFramework.DataTable.DTGameLevelMonster> CreateDTGameLevelMonster(FlatBufferBuilder builder,
      int Id = 0,
      int GameLevelId = 0,
      int Grade = 0,
      int RegionId = 0,
  ...
  public static Offset<HHFramework.DataTable.DTGameLevelMonster> EndDTGameLevelMonster(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<HHFramework.DataTable.DTGameLevelMonster>(o);
  }
}
