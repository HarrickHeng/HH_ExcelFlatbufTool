...
public struct Sys_StorySound : IFlatbufferObject
{
  ...
  public static Offset<HHFramework.DataTable.Sys_StorySound> CreateSys_StorySound(FlatBufferBuilder builder,
      int Id = 0,
  ...
  public static void StartSys_StorySound(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<HHFramework.DataTable.Sys_StorySound> EndSys_StorySound(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<HHFramework.DataTable.Sys_StorySound>(o);
  }
}
