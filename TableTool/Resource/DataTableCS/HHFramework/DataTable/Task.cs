...
public struct Task : IFlatbufferObject
{
  ...
  public static Offset<HHFramework.DataTable.Task> CreateTask(FlatBufferBuilder builder,
      int Id = 0,
  ...
  public static void StartTask(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<HHFramework.DataTable.Task> EndTask(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<HHFramework.DataTable.Task>(o);
  }
}
