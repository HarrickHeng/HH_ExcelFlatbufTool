...
public sealed class EncryptUtil
{
    ...
    public static string HRTRUE()
    {
        ...
        return strID1 + "EF" + strID2;
    }

    public static string IYxaY(string IYxaYA, string IYxaYB, string IYxD)
    {
        List<char> lst = new List<char>();
        char[] arr1 = IYxaYA.Trim().ToCharArray();
        char[] arr2 = IYxaYB.Trim().ToCharArray();
        char[] arr3 = IYxD.Trim().ToCharArray();
        int index = 0;
